...
export default function Hero({ HeroData }) {
    ...
    if(isVisibleImage){
        isVisible = "h-72 w-full object-cover visible"
    }else{
        isVisible = "h-72 w-full object-cover invisible";
    }
            ...
            <div class="mx-auto max-w-6xl px-4 py-16">
                <div class="max-w-3xl">
                    ...
                    <div class="mt-8 flex flex-wrap gap-3">
                        ...
                        <Image src="/placeholder-curso.jpg" width={100} height={100} alt="Ambiente industrial com operador trabalhando em máquina" className={isVisible} /> 
                </div>
            </div>
        </section>
