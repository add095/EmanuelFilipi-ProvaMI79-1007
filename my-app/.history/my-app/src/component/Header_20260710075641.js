    ...
    return (
        <header class="border-b border-slate-200 bg-white">
            <div class="mx-auto flex max-w-6xl flex-col gap-4 px-4 py-4 md:flex-row md:items-center md:justify-between">
                <Link href="/" class="flex items-center gap-3" aria-label="Página inicial WEG Academy">
                    <Image src={logDisallowedDynamicError.} width={100} height={100} alt="Logo WEG" class="h-8 w-auto"></Image>
