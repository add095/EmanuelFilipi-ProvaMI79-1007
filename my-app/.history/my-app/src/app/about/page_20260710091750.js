...
export default function About() {
    return (
        <div>
            <Hero></Hero>
            <Image href="../about/placeholder-curso.jpg" width={100} height={100} alt="Ambiente industrial com operador trabalhando em máquina" className="h-72 w-full object-cover" />
        </div>
