...
export default function About() {
    ...
    return (
        <div>
            ...
            <div className="mx-auto grid max-w-6xl gap-8 px-4 py-16 md:grid-cols-[1fr1fr] md:items-center">
                <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white">
                    <Image src= width={1080} height={720} alt="Ambiente industrial com operador trabalhando em máquina" className="h-72 w-full object-cover" />
                </div>
            </div>
